...
DateTime RTC_DS1340::enabletricklecharger2knodiode() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0xA6); // No diode, 2k resistor 
  Wire.endTransmission();
}

DateTime RTC_DS1340::enabletricklecharger2kdiode() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0xAA); // No diode, 2k resistor
  Wire.endTransmission();
}


DateTime RTC_DS1340::enabletricklecharger250nodiode() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0xA5); // No diode, 250ohm resistor dont use over 3.6v!!
  Wire.endTransmission();
}

DateTime RTC_DS1340::enabletricklecharger250diode() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0xA9); //  diode, 250ohm resistor  dont use over 3.6v!!
  Wire.endTransmission();
}


DateTime RTC_DS1340::enabletricklecharger4kdiode() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0xAB); // diode, 4kohm resistor 
  Wire.endTransmission();
}


DateTime RTC_DS1340::enabletricklecharger4knodiode() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0xA9); // no diode, 4kohm resistor 
  Wire.endTransmission();
}

DateTime RTC_DS1340::enabletricklechargerpoweronreset() {
  Wire.beginTransmission(DS1340_ADDRESS);
  Wire.write(8);	
  Wire.write(0x0); // poweron reset value
  Wire.endTransmission();
}
