...
#define DS1340_ADDRESS 0x68 ///< I2C address for DS1307
#define DS1340_CONTROL 0x07 ///< Control register
#define DS1340_NVRAM 0x08   ///< Start of RAM registers - 56 bytes, 0x08 to 0x3f
...
public:
  boolean begin(void);
    ...
    uint8_t isrunning(void);
    static DateTime now();
    static DateTime enabletricklecharger2knodiode(void);
 static DateTime enabletricklecharger250nodiode(void);
      static DateTime enabletricklecharger2kdiode(void);
 static DateTime enabletricklecharger250diode(void);  
    static DateTime disabletricklecharger(void);
    static DateTime enabletricklecharger4kdiode(void);  
       static DateTime enabletricklecharger4knodiode(void);  
     static DateTime enabletricklechargerpoweronreset(void); 
...
protected:
  static long offset; // kommt aus ds1340 lib die nicht ging
